...
GREETING_MESSAGE = (
    ...
    " Я могу принять заявку на экологическую и социальную помощь, или зарегистрировать тебя волонтёром."
...
MAKE_A_DONATION = "https://donate.delozhivet.ru/campaign/pomoch-delo-zhivet/"
