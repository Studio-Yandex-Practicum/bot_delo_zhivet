...
1. В папке infrastructure/ есть директория `.env.examples` с константами, которые необходимо заполнить тестовыми значениями.
Скопируйте из этой директории все файлы в `.env_files`

   Удалите из имени файлов `.example` после окончания их настройки.
Инструкция и примеры значений: https://www.notion.so/env-034f5557fa354aaf96220b4060b30ad8
